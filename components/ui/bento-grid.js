...
export const BentoGridItem = ({
  ...
  return (
    (<div
      ...
      {header}
      <div className="group-hover/bento:translate-x-2 transition duration-200 block text-center">
        <div
          className="font-bold text-xl text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
          {title}
        </div>
        <div
